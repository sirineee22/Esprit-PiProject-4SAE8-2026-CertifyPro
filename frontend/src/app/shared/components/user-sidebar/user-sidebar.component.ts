  ...
  template: `
    <aside class="user-sidebar-content" [class.collapsed]="isCollapsed">
      ...
      <nav class="sidebar-nav">
        ...
        <!-- Trainer Section (only for trainers and admins) -->
        <div class="nav-section" *ngIf="isTrainer || isAdmin">
          ...
          <a routerLink="/trainings" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" class="nav-link" [title]="isCollapsed ? 'Browse Trainings' : ''">
            <i class="bi bi-grid-view"></i>
            <span>Browse Trainings</span>
          </a>
