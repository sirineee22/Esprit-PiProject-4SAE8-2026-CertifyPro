        ...
        stage('Deploy to Kubernetes') {
            steps {
                withCredentials([file(credentialsId: 'kubeconfig-credentials', variable: 'KUBECONFIG')]) {
                    ...
                    sh """
                        sed -i 's|image:.*|image: ${DOCKER_IMAGE}:${params.DOCKER_TAG}|g' k8s/frontend-deployment.yaml
